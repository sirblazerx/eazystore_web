...
class OrderHistory extends StatelessWidget {
                      ...
                      child: InkWell(
                        onTap: () {
                          ConfirmOrderDialog(
                              ...
                              getTime(orders['Time'].toString()) +
                                  " " +
                                  getDate(orders['Time'].toString()),
                              orders['TableNo'].toString());
                        },
                        child:
  ...
  Future<void> ConfirmOrderDialog(BuildContext context, String details,
      String price, String time, String TableNo) async {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
